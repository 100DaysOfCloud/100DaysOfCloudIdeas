...
| Project Code | Project Details                                                         | Difficulty | CSP   | Author(s)                                        |
| :----------- | :---------------------------------------------------------------------- | :--------- | :---- | :----------------------------------------------- |
| OPS01-AWS100 |    [Deploy a CloudFormation template from AWS Console](Projects/OPS/OPS01/OPS01-AWS100.md)| Level 100  | AWS   | [Syed Auther](https://twitter.com/syedauther) |                                                  |
